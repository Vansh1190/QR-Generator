...
export default function Qrpage(props){
    ...
    let downloadQR = async(url, filename)=>{

    }
    downloadQR(("https://chart.googleapis.com/chart?cht=qr&chs=500x500&chl=" + id["*"] ), "my-image.png");
    const [Downlodadqrbutton,setdownloadqr] = useState([])
      ...
      {/* {console.log(id["*"])}     */}
       ...
       <img onLoad={()=>{
        //    console.log(downloadqr)
           ...
           setdownloadqr(
           <a href={"https://chart.googleapis.com/chart?cht=qr&chs=500x500&chl=" + id["*"] } download={"qr-code.png"}>
                    <button id="downloadNow" class="cssbuttons-io-button">
        ...
        //    console.log(downlodadqr)
           
        }} width={200} src={"https://chart.googleapis.com/chart?cht=qr&chs=500x500&chl=" + id["*"]} alt="" />
